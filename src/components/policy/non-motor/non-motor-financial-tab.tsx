...
// Phase 3A: reused directly, unchanged — both modals are already
// category-agnostic (see their own source), calling the same
// addCustomerReceiptAction/addProviderPaymentAction Motor uses.
...
import { NonMotorEditCommissionModal } from "@/components/policy/non-motor/non-motor-edit-commission-modal";
import type { NonMotorDetail, PolicyPaymentStatus } from "@/components/policy/types";
...
// Mirrors motor-financial-tab.tsx's layout exactly, minus
// HistoricalImportWarningCard — Non-Motor has no historical import in this
// phase, so insurerBalanceVerification/clientBalanceVerification never
// leave their schema defaults and there is nothing to warn about or
// resolve.
export function NonMotorFinancialTab({ detail, canEdit }: { detail: NonMotorDetail; canEdit: boolean }) {
