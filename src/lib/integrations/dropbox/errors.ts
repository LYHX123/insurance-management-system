...
export type DropboxErrorCode =
  ...
  // --- Phase 7: Claim synchronization ---
  | "CLAIM_NOT_FOUND"
  | "CLAIM_DOCUMENT_NOT_FOUND"
  | "CLAIM_DOCUMENT_CONFLICT"
  | "CLAIM_FOLDER_CONFLICT"
  | "CLAIM_POLICY_REASSIGNMENT_BLOCKED"
  // --- Dropbox Root Migration (Home namespace -> Team Folder namespace) ---
  | "MIGRATION_LOCKED"
  | "NAMESPACE_NOT_RESOLVED"
  | "NAMESPACE_NOT_TEAM_ELIGIBLE"
  | "DESTINATION_WRITE_DENIED"
  | "DESTINATION_ROOT_CONFLICT"
  | "WRITE_TEST_FAILED"
  | "WRITE_TEST_CLEANUP_FAILED"
  | "CROSS_NAMESPACE_COPY_UNSUPPORTED"
  | "COPY_JOB_FAILED"
  | "COPY_JOB_TIMEOUT"
  | "COPY_CONFLICT"
  | "COPY_SOURCE_MISSING"
  | "COPY_DESTINATION_MISMATCH"
  | "VERIFICATION_INCOMPLETE"
  | "ACTIVATION_BLOCKED"
  | "METADATA_RERESOLUTION_FAILED"
  | "PENDING_SYNC_REPLAY_FAILED"
